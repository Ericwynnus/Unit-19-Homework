...
# Write the client's Ethereum account address to the sidebar (check with tutor here)
#st.sidebar.write("account.address" + "get_balance")
...
# YOUR CODE HERE(Check with tutor here)
